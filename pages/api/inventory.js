...
export default async function handler(req, res) {
  try {
    ...
    // ===========================
    if (req.method === "PUT") {
      const { id, name, quantity, restockMin, unit, allergy, restockOrdered, isTopping } = req.body;
      ...
      const result = await query(
        ...
        RETURNING *;
        `,
        [name, quantity, restockMin, unit, allergy, restockOrdered, isTopping ?? false, id]
      );
